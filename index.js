...
client.on('message', async msg => {
    try {
        switch (msg.type) {
            case 'list_response':
                client.sendMessage(msg.from, await selectLists(msg.selectedRowId), {linkPreview: false});
                break;
            case 'chat':
        ...
        console.log(err)
        client.sendMessage("97333959459@c.us", `${err.message}\nFrom: ${msg.from}\n\n\n${msg.body}`);
        client.sendMessage(msg.from,"*Error Reported*\nContact:\nAkaa: https://wa.me/97333959459\nAli Redha: https://wa.me/97338406875");
    }
});
